...
function custom_theme_enqueue()
{
    ...
    wp_register_style('splide_style', 'https://cdn.jsdelivr.net/npm/@splidejs/splide@4.1.4/dist/css/splide.min.css', [], $ver);
    ...
    wp_register_script('splide_script', 'https://cdn.jsdelivr.net/npm/@splidejs/splide@4.1.4/dist/js/splide.min.js', $ver, true);
