...
const projectURL = 'http://customtheme.local/';
...
const textDomain = 'customtheme';

// Name of the translation file.
const translationFile = 'customtheme.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'customtheme';
